...
namespace Ticketing.Infrastructure.EFCore.Migrations
{
    ...
    [Migration("20230220211024_AddFormReplyTable")]
    partial class AddFormReplyTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ticketing.Domain.FormReplyAgg.FormReply", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("FormsReplies", (string)null);
                });
            ...
            modelBuilder.Entity("Ticketing.Domain.FormReplyAgg.FormReply", b =>
                {
                    b.HasOne("Ticketing.Domain.FormAgg.Form", "Form")
                        .WithMany("Replies")
